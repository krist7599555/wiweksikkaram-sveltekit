...
export type PostsRecord<Tattribute = unknown, Tpodbean = unknown> = {
    attribute?: null | Tattribute;
...
export type PostsResponse<Tattribute = unknown, Tpodbean = unknown, Texpand = unknown> = Required<
    PostsRecord<Tattribute, Tpodbean>
> &
    BaseSystemFields<Texpand>;
